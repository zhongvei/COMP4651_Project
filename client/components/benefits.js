...
export default function Benefits(props) {
  ...
  return (
    <>
      <Container className="flex flex-wrap mb-20 lg:gap-10 lg:flex-nowrap " style={{paddingTop: "100px"}}>
        <div
  ...
  return (
    <>
      <div className="flex items-start mt-8 space-x-3">
        ...
        <div>
          <h4 className="text-xl font-medium text-white-800 dark:text-gray-200">
            {props.title}
          </h4>
          <p className="mt-1 text-white-500 dark:text-gray-400">
            {props.children}
          </p>
        </div>
      </div>
